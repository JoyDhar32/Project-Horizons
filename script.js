...
function init() {
    ...
    for (let i = 0; i < 300; i++) {
        const floorSize = 1000; // Adjust for desired "infinite" floor area
        ...
        sphere.position.x = Math.random() * floorSize * 2 - floorSize; // Ensures values between -floorSize and floorSize
        sphere.position.y = Math.random() * (10 - 1) + 1;  // Ensures values between 1 and 10
        sphere.position.z = Math.random() * floorSize * 2 - floorSize; // Ensures values between -floorSize and floorSize
